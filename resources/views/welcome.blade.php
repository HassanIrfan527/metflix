...
<body class="antialiased font-sans text-white bg-gray-900">
    ...
    <div class="p-12 mt-12 pt-8 text-center text-gray-400">
        ...
        <div
            ...
            <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and watch movies from your mobile with our iOS and Android app, and enjoy!</p>
